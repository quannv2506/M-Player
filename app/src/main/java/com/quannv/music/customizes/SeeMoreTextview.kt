...
class SeeMoreTextView constructor(context: Context, attrs: AttributeSet) :
    CustomTextViewFonts(context, attrs) {

    private var showingLine = 4

    private var showMore = ""
    private var showLess = ""
    private val threeDot = "…"

    private var showMoreTextColor = Color.parseColor("#FF891E")
    private var showLessTextColor = Color.parseColor("#FF891E")
