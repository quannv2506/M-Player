...
object DateTimeUtils {
    ...
    private fun getFormatter(pattern: String, contextForLocale: Context? = null): SimpleDateFormat {
        val locale = when (contextForLocale) {
            null -> Locale.getDefault()
            else -> contextForLocale.resources.configuration.locales[0]
        }
    ...
    fun getDateFormatted(datetime: Long, context: Context): String {
        ...
        return when {
            ...
            daysDiff == 1L -> context.getString(R.string.common_yesterday).lowercase()
