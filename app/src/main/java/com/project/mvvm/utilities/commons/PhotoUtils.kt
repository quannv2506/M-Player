...
class PhotoUtils {
    ...
    companion object {
        ...
        private const val AUTHORITY: String = "com.tcom.mmc.authentication.fileprovider"
    ...
    fun fromCamera(
        ...
        LogUtils.i("camera", "startCameraActivity()")
    ...
    fun onActivityResult(fragment: Fragment, requestCode: Int, resultCode: Int, data: Intent?) {
        if (resultCode == Activity.RESULT_OK) {
            when (requestCode) {
                ...
                REQUEST_CODE_CAMERA -> {
                    LogUtils.i("SonaSys", "resultCode: $resultCode")
                    onPhotoTaken()
                }
            }
        }
    ...
    private fun onPhotoTaken() {
        // Log message
        LogUtils.i("SonaSys", "onPhotoTaken")
